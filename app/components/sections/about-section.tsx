    ...
    <section id="about" className="py-24 sm:py-32">
      ...
      <div className="grid gap-8 lg:grid-cols-2">
        <div className="flex flex-col">
          <div>
            <p className="mb-4">
            I'm an architectural designer with an aptitude and interest to adapt to emerging technologies while maintaining focus on thoughtful design outcomes. My career has progressed from remedial drafting and landscaping to developing sophisticated architectural projects at H&E Architects, where I navigate between technical precision and creative vision.
            </p>
            <p className="mb-4">
